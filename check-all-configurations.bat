...
echo.
echo 기본 설정 (application.yml):
echo - 포트: 8084
echo - Context Path: /mba
echo - Eureka: 비활성화
echo.
echo 개발 환경 (application-dev.yml):
echo - 포트: 8084
echo - Context Path: /mba
...
echo 기본 설정 (application.yml):
echo - 포트: 8085
echo - Context Path: /mbc
echo - Eureka: 비활성화
echo.
echo 개발 환경 (application-dev.yml):
echo - 포트: 8085
echo - Context Path: /mbc
echo - 접속 URL: http://localhost:8085/mbc/home
echo.
echo 테스트 환경 (application-test.yml):
echo - 포트: 8085
echo - Context Path: /mbc
echo.
echo 운영 환경 (application-prod.yml):
echo - 포트: 8085
echo - Context Path: /mbc
echo.
...
echo - MBC via Gateway: http://localhost:8000/mbc -> http://localhost:8085/mbc
echo.
