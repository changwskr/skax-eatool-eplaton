@echo off
echo ========================================
echo MBA 서비스 실행 (최소 메모리)
echo ========================================
echo.

REM 현재 디렉토리를 MBA 디렉토리로 변경
cd /d "%~dp0\mba-java"
...
echo.
echo 접속 URL:
echo - MBA Service: http://localhost:8084/mba
echo - H2 Console: http://localhost:8084/mba/h2-console
echo - Swagger UI: http://localhost:8084/mba/swagger-ui.html
echo - Health Check: http://localhost:8084/mba/actuator/health
echo.
