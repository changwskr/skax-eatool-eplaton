...
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/exception/BTFSPException.java
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/exception/CommonDCException.java
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/exception/CommonPCException.java
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/exception/TPMRecvException.java
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/exception/TPMSendException.java
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/exception/DelegateException.java
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/exception/ErrMsgFilter.java
echo.
echo [Foundation/Utility 패키지 - 유틸리티 클래스들]
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/foundation/utility/GenericDtoUtil.java
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/foundation/utility/Reflector.java
echo - mbc01-java/src/com/skax.eatool/mbc/fc/foundation/bzcrudbus/foundation/utility/Utils.java
echo.
...
echo 7. 주의사항:
echo    - com.skax.eatool.ksa 패키지 관련 import 오류는 의존성 문제로 별도 해결 필요
