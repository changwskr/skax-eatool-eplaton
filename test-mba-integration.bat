@echo off
echo ========================================
echo API Gateway + MBA 서비스 연동 테스트
echo ========================================
echo.

REM 포트 사용 중인 프로세스 종료
echo 포트 8000, 8081 사용 중인 프로세스 확인 및 종료...
...
echo - MBA Service 직접: http://localhost:8081
...
echo 3. http://localhost:8081 접속하여 직접 MBA 서비스 응답 확인
echo.
